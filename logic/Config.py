    ...
    "equip": {  # 强化
        ...
        "polish": {  # 炼化
            ...
            "baowu": {  # 家传玉佩
                ...
                "limit": 999,  # 属性和上限, 超过则不强化
            },
            "specialtreasure": {  # 专属玉佩
                "enable": True,  # 强化专属玉佩
                "reverse": 5,  # 保留N个0属性专属玉佩
                "attribute": [  # 专属玉佩技能要求
                ...
                "include": [221422, 231857, 326601],  # 例外
                "include_general": ["李广"],  # 装备的专属玉佩例外
                "available_attribute_len": {  # 有效的属性 {共有多少个属性: 至少有多少个有效属性}
                    1: 1,
                    2: 2,
                    3: 2,
                    4: 3,
